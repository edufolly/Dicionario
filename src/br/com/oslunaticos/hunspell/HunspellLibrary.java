...
public interface HunspellLibrary extends Library {
     ...
     *
     * @param pHunspell The Hunspell object returned by Hunspell_create
     * @param slst input: pointer to an array of strings pointer and the (bad)
     * word array of strings pointer (here *slst) may not be initialized output:
     * number of suggestions in string array, and suggestions in a newly
     * allocated array of strings (*slts will be NULL when number of suggestion
     * equals 0.)
